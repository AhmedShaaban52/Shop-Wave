    ...
    return (
        <section className="group flex flex-col bg-white rounded-[1.5rem] shadow-sm overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-gray-100 cursor-pointer">
            ...
            <div className="p-6 flex flex-col flex-grow space-y-3">
                ...
                <h3 className="text-lg font-bold text-[#0c314e] tracking-tight leading-snug group-hover:text-[#00628c] transition-colors line-clamp-1">
                    {product.name}
                </h3>
                ...
                <div className="mt-auto pt-2 flex items-baseline gap-3 pb-4">
